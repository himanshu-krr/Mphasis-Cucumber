...
//	String filePath = "./TestData/TestData.xlsx";
	String filePath = "./TestData/TestData2.xlsx";
	
	public int ReadFirstName() throws IOException
...
//		String fnm = cell.getStringCellValue(); //Reads and stores the text value from the cell.
		int fnn = (int) cell.getNumericCellValue();
...
//        String firstName = registerDemo.ReadFirstName();
        int fnn = registerDemo.ReadFirstName();
